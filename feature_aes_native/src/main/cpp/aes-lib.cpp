...
extern "C" jbyteArray
Java_com_mercandalli_android_sdk_feature_1aes_1native_internal_AesNativeInternal_encodeByteArray(
        JNIEnv *env,
        jobject /* this */,
...
extern "C" jbyteArray
Java_com_mercandalli_android_sdk_feature_1aes_1native_internal_AesNativeInternal_decodeByteArray(
        JNIEnv *env,
        jobject /* this */,
...
extern "C" void
Java_com_mercandalli_android_sdk_feature_1aes_1native_internal_AesNativeInternal_debug(
        JNIEnv *env,
        jobject /* this */,
        jstring debug_
) {
